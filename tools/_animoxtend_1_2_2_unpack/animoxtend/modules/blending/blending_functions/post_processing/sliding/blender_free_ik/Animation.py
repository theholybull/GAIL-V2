...
class Animation:
    ...
    def __init__(self, rotations, positions, orients, offsets, parents):
        self.rotations = rotations  # all joints rotations in Quat, root ->global rot, joints -> relative parent rot
        self.positions = positions  # all joints positions, root ->global pos, joints -> global space offsets
        self.orients = orients  # all 1,0,0,0
        self.offsets = offsets  # parent坐标系下的offset
